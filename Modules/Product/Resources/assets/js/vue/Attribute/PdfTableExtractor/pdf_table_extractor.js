...
export function pdfTableExtractor(doc) {
  ...
  var loadPage = function (pageNum) {
    return doc.getPage(pageNum).then(function (page) {
      ...
      return page.getOperatorList().then(function (opList) {
        ...
        // handle merge cells
        var x_list = verticles.map(function(a){ return a.x; });
        ...
        // выше код как я понимаю определяет все места где находятся таблицы
