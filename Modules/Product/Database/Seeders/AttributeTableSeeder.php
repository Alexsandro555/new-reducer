...
class AttributeTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $arrAttributes = [
        ...
        ['title' => '1п/1н', 'attribute_type_id' => 4, 'attribute_group_id' => 1],
        ['title' => 'Мп/Мн', 'attribute_type_id' => 4, 'attribute_group_id' => 1],
        ['title' => 'Мтах/Мн', 'attribute_type_id' => 4, 'attribute_group_id' => 1],
